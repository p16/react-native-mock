...
var NavigationExperimental = {
  StateUtils: (0, _createMockComponent2['default'])('NavigationStateUtils'),
  Reducer: (0, _createMockComponent2['default'])('NavigationReducer'),
  ...
  PropTypes: (0, _createMockComponent2['default'])('NavigationPropTypes')
};
